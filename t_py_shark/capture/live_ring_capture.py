...
class LiveRingCapture(LiveCapture):
    ...
    def __init__(self, ring_file_size=1024, num_ring_files=1, ring_file_name='/tmp/t_py_shark.pcap', interface=None,
        ...
        :param ring_file_name: Name of the ring file, default is /tmp/t_py_shark.pcap
